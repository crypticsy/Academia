<%@ Page Title="StudentFee" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentFee.aspx.cs" Inherits="BerkleyCollegeSystem.WebForm5" %>
    ...
    <div class="row">
		<div class="col d-flex comfortaa-light text-sm">
			<div class="card flex-fill p-4 shadow">
                ...
                <div class="mb-2">
                    <h5><asp:Label ID="Label3" class="intro-rust" runat="server" Text="Student Fee Mapping Form"></asp:Label></h5>
                    <hr />
                </div>
		...
		<div class="col d-flex">
			<div class="card flex-fill p-4 shadow">
				...
				<div class="">
                    ...
                    <asp:GridView   ID="StudentFeeGridView" runat="server"
