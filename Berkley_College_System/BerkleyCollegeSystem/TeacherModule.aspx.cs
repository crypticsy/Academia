    ...
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            cmd.CommandText = @"select p.first_name as ""First Name"", p.last_name as ""Last Name"", p.phone_number as ""Phone Number"",
                                m.module_code as ""Module Code"", m.module_name as ""Module Name""
                                from teacher t
                                inner join person p on p.person_id = t.teacher_id
                                inner join module_teacher mt on mt.teacher_id = t.teacher_id
                                inner join module m on m.module_code = mt.module_code";
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = @"select p.first_name as ""First Name"", p.last_name as ""Last Name"",
                                ...
                                inner join person p on p.person_id = t.teacher_id
                                inner join module_teacher mt on mt.teacher_id = t.teacher_id
                                inner join module m on m.module_code = mt.module_code where t.teacher_id = '" + teacher_id +"'" ;
